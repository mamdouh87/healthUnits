...
describe('Doctors Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'doctors', component: DoctorsComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to doctorsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDoctorsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDoctorsIdentifier).toHaveBeenCalledWith(entity);
