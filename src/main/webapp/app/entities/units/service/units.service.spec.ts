...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../units.test-samples';

import { UnitsService } from './units.service';

const requireRestSample: IUnits = {
...
describe('Units Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Units', () => {
      ...
      const units = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(units).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Units', () => {
      const units = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(units).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addUnitsToCollectionIfMissing', () => {
      it('should add a Units to an empty array', () => {
        const units: IUnits = sampleWithRequiredData;
      ...
      it("should add a Units to an array that doesn't contain it", () => {
        const units: IUnits = sampleWithRequiredData;
        const unitsCollection: IUnits[] = [sampleWithPartialData];
        expectedResult = service.addUnitsToCollectionIfMissing(unitsCollection, units);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(units);
      });
      ...
      it('should add only unique Units to an array', () => {
        const unitsArray: IUnits[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const unitsCollection: IUnits[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const units: IUnits = sampleWithRequiredData;
        const units2: IUnits = sampleWithPartialData;
    ...
    describe('compareUnits', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareUnits(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareUnits(entity1, entity2);
        const compareResult2 = service.compareUnits(entity2, entity1);
